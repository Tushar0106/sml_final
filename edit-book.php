...
$id = $_GET['id'];
$books = mysql_query( "SELECT * from  tblbooks WHERE id = '".$id."' ",$con1);
...
if(isset($_POST['submit']))
{
            ...
            UpdationDate = now() WHERE id = '".$id."' ";
            $record = mysql_query($sql,$con1);
            if ($record) {
              $msg = "Book update successfully";
            }
            else{
              $msg = "Book not updated, please try again";
            }
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-9">
                ...
                <input class="form-control" id="name" name="name" type="text" placeholder="<?php if(isset($errors['name'])){ echo $errors['name']; }  ?>" value="<?php echo $row['BookName'];  ?>" >
              </div>
              <div class="col-md-3">
