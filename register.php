...
if (isset($_POST['submit'])) {
  ...
  if (!count($errors)) {
    ...
    $select =  mysql_query("select * from students where username = '".$_POST['username']."' ",$con);
          ...
          if ($_POST['password'] == $_POST['cpassword']  && $_POST['clg_code'] == '100')  {
            ...
            //$record = mysql_query($sql,$con);
              ...
              if (mysql_query($sql,$con)) {
               //$_SESSION['slam']['msg'] = "You are registration Successfully";
                $msg = "You are registration Successfully";
              // header('location: login.php');
               //$_SESSION['msg'] = "You are registration Successfully";
              }
              else{
               //$_SESSION['slam']['msg'] = "You are registration Fail, Please try again";
                $msg = "You are registration Fail, Please try again";
                //alert("You are registration Fail, Please try again");
              }
          }
          else{
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-3">
                ...
                <input class="form-control" id="roll_no" name="roll_no" type="text" placeholder="<?php if(isset($errors['roll_no'])){ echo $errors['roll_no']; }  ?>">
              </div>
            </div>
          </div>
          <div class="form-group">
