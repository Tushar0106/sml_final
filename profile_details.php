      ...
      <div class="card mb-3">
        <div class="card-body view_pro" style="text-align: center">
          ...
          <div class="form-group">
            <button id="submit" name="submit" class="btn btn-success edit"><a href="edit_admin_profile.php?id=<?php echo $_SESSION['slam']['id'];?>" style="color:#fff;">Edit Profile</a></button>
          </div>
          <div class="head_name">
