...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2018 at 08:20 PM
...
INSERT INTO `tblbooks` (`id`, `BookName`, `department`, `author`, `book_code`, `publication`, `BookPrice`, `RegDate`, `UpdationDate`) VALUES
(1, 'PHP And MySql programming test', '', '1', 222333, 'dev', 20, '2017-07-08 20:04:55', '2018-03-11 11:37:09'),
...
CREATE TABLE `tblissuedbookdetails` (
  `id` int(11) NOT NULL,
  `book_code` int(11) DEFAULT NULL,
  `StudentEnrollment` varchar(150) DEFAULT NULL,
...
INSERT INTO `tblissuedbookdetails` (`id`, `book_code`, `StudentEnrollment`, `IssuesDate`, `ReturnDate`, `RetrunStatus`, `fine`) VALUES
(6, 3, 'SID011', '2017-07-15 18:02:55', NULL, 0, NULL),
(14, 123, 'SID009', '2018-03-02 13:42:34', '2018-03-02 13:42:34', 0, NULL),
(15, 123, 'SID009', '2018-03-02 17:41:21', '2018-03-02 17:41:21', 0, NULL),
(16, 1111, '9', '2018-03-11 19:08:56', '2018-03-11 19:08:56', 0, NULL),
(17, 222333, 'SID002', '2018-03-11 19:14:21', '2018-03-11 19:14:21', 0, NULL);
...
INSERT INTO `tblstudents` (`id`, `StudentEnrollment`, `FullName`, `EmailId`, `MobileNumber`, `Password`, `Status`, `RegDate`, `UpdationDate`) VALUES
(1, 'SID002', 'Anuj kumar', 'anuj.lpu1@gmail.com', '9865472555', 'f925916e2754e5e03f75dd58a5733251', 0, '2017-07-11 15:37:05', '2018-03-02 05:55:44'),
...
ALTER TABLE `tblstudents`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `StudentId` (`StudentEnrollment`);
